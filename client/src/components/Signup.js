  ...
  return (
    ...
    <Card>
        ...
        <Form.Group as={Col} controlId="formGridLastName">
          ...
          <Form.Control type="lastname" onChange={(e)=>{setLastName(e.target.value)}} placeholder="Enter Last Name" />
        </Form.Group>
      </Row>
      <Row className="mb-3">
        <Form.Group as={Col} id ="email" controlId="formGridEmail">
          <Form.Label>Email</Form.Label>
          <Form.Control type="email" ref= {emailRef} onChange={(e)=>{setEmail(e.target.value)}} placeholder="Enter email" />
        </Form.Group>

        <Form.Group as={Col} id ="password" controlId="formGridPassword">
          <Form.Label>Password</Form.Label>
          <Form.Control type="password"  onChange={(e)=>{setPassword(e.target.value)}} ref= {passwordRef} placeholder="Enter password" />
        </Form.Group>
      </Row>
      ...
      <Form.Group className="mb-3" controlId="formGridCellPhoneNo">
        ...
        <Form.Control onChange={(e)=>{setCphone(e.target.value)}} placeholder="Cell-Phone Number" />
      </Form.Group>
      ...
      <Row className="mb-3">
        ...
        <Form.Group as={Col} controlId="formGridZip">
          ...
          <Form.Control type="number" onChange={(e)=>{setZip(e.target.value)}} />
        </Form.Group>
      </Row>
